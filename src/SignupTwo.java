...
public class SignupTwo extends JFrame implements ActionListener{
	...
	SignupTwo(String formno) {
		...
		String valReligion[] = {"Muslim", "Christian", "Jews", "Hindu", "Other"};
		...
		String valIncome[] = {"Null", "< 1 Lakh", "< 2 Lakh", "< 5 Lakh", "More than 5 Lakh"};
		...
		String educationValues[] = {"High School", "Bachelors", "Masters", "Doctorate", "Others"};
